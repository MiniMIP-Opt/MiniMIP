...
typedef unsigned int LPIndex; /**< unsigned integer representing an index in LP solvers*/
typedef std::vector<LPIndex> LPIndexArray;

typedef unsigned int LPNum; /**<  unsigned integer representing a number or count in LP solvers*/
