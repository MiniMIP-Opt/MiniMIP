...
#ifndef MINIMIP_CUTTING_INTERFACE_CUT_GENERATORS_AGGREGATING_CUT_GENERATORS_H_
#define MINIMIP_CUTTING_INTERFACE_CUT_GENERATORS_AGGREGATING_CUT_GENERATORS_H_
...
class TableauRoundingGenerator : public CutGeneratorInterface {
 public:
  explicit TableauRoundingGenerator(CutGeneratorParameters params)
    ...
    VLOG(10) << "calling TableauRoundingGenerator().";
...
#endif  // MINIMIP_CUTTING_INTERFACE_CUT_GENERATORS_AGGREGATING_CUT_GENERATORS_H_
